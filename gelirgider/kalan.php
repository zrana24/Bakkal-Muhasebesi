...
gelir_gider WHERE tarih < '".$tarih."'), 0) as toplamgelir FROM gelir_gider WHERE tarih = '".$tarih."'";
...
echo "<h6>GELİR: ".$gelir."&nbsp&nbsp GİDER: ".$gider."<br><br>TOPLAM GELİR: ".$tgelir."&nbsp&nbsp KALAN: ".$kalan."</h6>";
